...
<body>
    ...
    <div class="content">
        ...
        <h1 class="alert-heading text">TERM OF US</h4>
        </div>
        </div>
        <div class="word">
    <h3><br/><p>Please understand information published in the BEAUTY AND SPA website will sometimes be changed or removed</p>
     <p>without notice. Regardless of our careful and close attention, BEAUTY AND SPA will not guarantee the accuracy,</p>
     <p>usefulness or appropriate renewal timing of published information.</p></h3>
    </div>
