...
<body>
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <img src="{{ url('images/spa.jpeg') }}" class="rounded mx-auto d-block" width="150" alt=""> 
...
<div class="container">
    ...
    <div class="col-md-12 mb-3">
        <!-- <img src="{{ url('images/spa-spa.jpg') }}" class="rounded mx-auto d-block" width="600" alt=""> -->
    ...
    @foreach ($barangs as $barang)
        <div class="card"  class="col-md-4">
            <h5 class="card-header">{{ $barang -> nama_barang }}</h5>
                <div class="card-body">
                ...
                <br>
                <br>
                <a href="{{url('pesan')}}/{{$barang->id}}" class="btn btn-primary">Booking</a>
                </div>
    @endforeach 
